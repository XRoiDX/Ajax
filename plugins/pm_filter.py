    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⬅️ 𝘽𝙖𝙘𝙠", callback_data=f"next_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"🌹 𝙋𝙖𝙜𝙚 {round(int(offset) / 10) + 1} / {round(total / 10)}",
                                  callback_data="pages")]
        )
    elif off_set is None:
        btn.append(
            [InlineKeyboardButton(f"🌹 𝙋𝙖𝙜𝙚 {round(int(offset) / 10) + 1} / {round(total / 10)}", callback_data="pages"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/+wfEnWYW80JEwY2Y1'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/+wfEnWYW80JEwY2Y1')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ 𝚈𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻  ✅', url='https://bit.ly/3EFfkJN')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton("Iᴍᴀɢᴇ Eᴅɪᴛɪɴɢ📷", callback_data='image')
            ],[
            InlineKeyboardButton('Fᴜɴ Mᴏᴅᴜʟᴇꜱ😜', callback_data='fun'), 
            ...
            InlineKeyboardButton('Wʜᴏ ɪꜱ🤵', callback_data='whois'),
            InlineKeyboardButton('Mᴜᴛᴇ🔇', callback_data='restric'),
            InlineKeyboardButton('Kɪᴄᴋ🛴', callback_data='zombies')
            ],[
            InlineKeyboardButton('Rᴇᴩᴏʀᴛ‼️', callback_data='report'),
            InlineKeyboardButton('Yᴛ-Tʜᴜᴍʙ🕹️', callback_data='ytthumb'),
            InlineKeyboardButton('Sᴛɪᴄᴋᴇʀ Iᴅ🌈', callback_data='sticker')
            ],[
            InlineKeyboardButton('Cᴏᴠɪᴅ Dᴇᴛᴀɪʟꜱ🦠', callback_data='corona'),
            InlineKeyboardButton('Aᴜᴅɪᴏ-ʙᴏᴏᴋ📒', callback_data='abook'),
            InlineKeyboardButton('Uʀʟ-ꜱʜᴏʀᴛ🔗', callback_data='urlshort')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('❤ ᴍʟᴍ ᴍᴏᴠɪᴇꜱ ᴡᴏʀʟᴅ ♥️', url='https://t.me/+wfEnWYW80JEwY2Y1')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"🌹 𝙋𝙖𝙜𝙚 1/{round(int(total_results) / 10)}", callback_data="pages"),
             InlineKeyboardButton(text="𝙉𝙚𝙭𝙩 ➡️", callback_data=f"next_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="🌹 𝙋𝙖𝙜𝙚 1/1", callback_data="pages")]
        )
